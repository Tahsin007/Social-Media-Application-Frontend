...
const PostCard = ({ post }) => {
    ...
    const { deletePost, togglePostLike } = usePostMutations();
    ...
    const { id, user, content, imageUrl, createdAt, isPublic, likeCount, isLikedByCurrentUser, commentCount } = post;

    const handleLike = async () => {
        try {
            // The mutation in usePosts hook will handle UI updates on success.
            ...
            <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
                                    ...
                                    <div id="_timeline_drop" className="_feed_timeline_dropdown _timeline_dropdown" style={{ opacity: 1, visibility: 'visible', transform: 'translateY(25px)' }}>
                                        <ul className="_feed_timeline_dropdown_list">
                                            <li className="_feed_timeline_dropdown_item">
                                                <a href="#0" className="_feed_timeline_dropdown_link" onClick={handleEdit}>Edit Post</a>
                                            </li>
                                            <li className="_feed_timeline_dropdown_item" onClick={handleDelete}>
                ...
                <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
                    ...
                    <div className="_feed_inner_timeline_total_reacts_txt">
                        <p className="_feed_inner_timeline_total_reacts_para1" onClick={() => setShowComments(!showComments)}>
                            <a href="#0"><span>{commentCount}</span> Comment</a>
                        </p>
                ...
                <div className="_feed_inner_timeline_reaction">
                    <button onClick={handleLike} className={`_feed_inner_timeline_reaction_emoji _feed_reaction ${isLikedByCurrentUser ? '_feed_reaction_active' : ''}`}>
                        <span className="_feed_inner_timeline_reaction_link">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="none" viewBox="0 0 19 19">
                                    <path fill={isLikedByCurrentUser ? "#FFCC4D" : "#666"} d="M9.5 19a9.5 9.5 0 100-19 9.5 9.5 0 000 19z" />
                                    {/* other paths */}
                                </svg>
                                Like
                            </span>
                    ...
                    <button onClick={() => setShowComments(!showComments)} className="_feed_inner_timeline_reaction_comment _feed_reaction">
                        <span className="_feed_inner_timeline_reaction_link">
                            <span>
